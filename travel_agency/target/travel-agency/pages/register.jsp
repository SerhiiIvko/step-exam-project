                    ...
                    <center>
                        ...
                        <form action="register.jsp" method="post" class="form-horizontal">
                            <div class="form-group ">
                                <label for="firstname" class="col-md-2 control-label">Name<span
                                        class="glyphicon glyphicon-asterisk" aria-hidden="true"></span> </label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group ">
                                <label for="lastname" class="col-md-2 control-label">Surname<span
                                        class="glyphicon glyphicon-asterisk" aria-hidden="true"></span> </label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group ">
                                <label for="age" class="col-md-2 control-label">Age<span
                                        class="glyphicon glyphicon-asterisk" aria-hidden="true"></span> </label>
                                <div class="col-md-10">
                                    <input class="form-control" id="age" name="passport" type="text" value=""
                                           placeholder="age"/>
                                </div>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group">
                                <label for="passwordCheck" class="col-md-2 control-label">Repeat<span
                                        class="glyphicon glyphicon-asterisk" aria-hidden="true"></span></label>
                                <div class="col-md-10">
